...
const dogSpot2 = new CellDoorZ(596, 206, "green", 10, 10);
...
const neighborFive = new Neighbor(100, 460, "red", 45, 45);
const neighborSix = new Neighbor(320, 460, "brown", 60, 65);
const neighborSeven = new Neighbor(500, 470, "grey", 55, 70);
const neighborEight = new Neighbor(700, 480, "black", 50, 50);
...
const n8Spot = new CellSpot(680, 450, "#bada55", 32, 48);
